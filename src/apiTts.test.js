import handler, { MAX_TEXT_LENGTH, SUPPORTED_LANGUAGE } from "../api/tts";
...
test("API rejects non-POST, invalid language, blank, and oversized text", async () => {
...
test("API restricts CORS and does not expose credentials", async () => {
